                ...
                <DialogContent>
                  <DialogActions>
                    <ImageCropper
                      ...
                      changeImageUrl={changeQuestionImageUrl}
                      cropShape={"rect"}
                      changeImageBlob={changeQuestionImageBlob}
                      aspectRatio={9 / 12}
                    ></ImageCropper>
                  </DialogActions>
                </DialogContent>
            ...
            >
                  ...
                  return (
                    <Grid size={6} key={choice.uid}>
                      <Radio
                        ...
                        onClick={() => changeCorrectChoice(choice.uid)}
                      ></Radio>
                      <TextField
                        minRows={2}
                        maxRows={2}
                        ...
                        value={choice.choice}
                        onChange={(e) => {
                          changeChoice(choice.uid, e.target.value);
                        }}
                      ></TextField>
                    </Grid>
                  );
              ...
              >
                ...
                <span style={{ fontWeight: 600 }}>
                  {question.choices.find((choice) => choice.is_answer)
                    ?.choice || " "}
                </span>
              </Typography>
            </Stack>
